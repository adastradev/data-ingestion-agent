...
describe('SendDataHandler', () => {
    ...
    describe('when handling a message', () => {
        ...
        it('should successfully return after handling a preview message', async () => {
            const message: IMessage = SendDataMessage.create({ preview: true }, "1234");
            ...
            expect(writerSpy.callCount).to.eq(0);
        });

        it('should successfully return after handling a non-preview message', async () => {
            const message: IMessage = SendDataMessage.create({ preview: false }, "1234");
