        ...
        switch (integrationType) {
            ...
            case IntegrationType.PeopleSoft: {
                ...
                PEOPLESOFT_TEMPLATE_STATEMENTS.push({
                    ...
                    query: `Select CONDITION_SPEC, EFFDT, EFF_STATUS, INSTITUTION, RQ_CONNECT    query: "SELECT EMPLID, NAME, LAST_NAME, FIRST_NAME, MIDDLE_NAME, NAME_TYPE, CASE WHEN EFFDT < date '1901-01-01' THEN date '1901-01-01' ELSE EFFDT END as EFFDT FROM PS_NAMES`
                });
                PEOPLESOFT_TEMPLATE_STATEMENTS.push({
                    name: 'PS_RQ_COND_LINE',
                    query: 'Select CONDITION_SPEC, EFFDT, COND_LINE_SEQ, COND_PROCESS_TYPE, COND_PROCESS_ID, CONDITION_CODE, CONDITION_OPERATOR, CONDITION_DATA, '
