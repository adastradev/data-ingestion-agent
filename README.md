...
* [Docker version 18.02 or greater](https://docs.docker.com/engine/install/) (Community Edition or any Enterprise Edition)
  ...
  * [Docker download for Linux (Ubuntu)](https://docs.docker.com/engine/install/ubuntu/)
  * [Docker download for Linux (Debian)](https://docs.docker.com/engine/install/debian/)
  * [Docker download for Linux (CentOS)](https://docs.docker.com/engine/install/centos/)
  * [Docker for Redhat Enterprise Linux (RHEL)](https://www.redhat.com/en/topics/containers/what-is-docker)
